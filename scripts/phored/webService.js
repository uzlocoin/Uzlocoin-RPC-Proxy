...
function createUri() {
    ...
    return config.uzlocoind_host + ":" + config.uzlocoind_rpc_port + config.uzlocoind_rpc_path;
}
...
function main() {
    ...
    app.listen(config.uzlocoind_web_port, () => {
        console.log("App is running on port", config.uzlocoind_web_port);
    });
